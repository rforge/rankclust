#' The Kendall's distance between two ranks is the number of pairs that are in different order in the two ranks
#' @title Kendall's distance between two ranks
...
#' Spearman's distance is a square of Euclidean distance between two rank vector
#' @title Spearman's distance between two ranks
#' @author Julien Jacques
#' @param x,y two ranks of size m 
...
#' Cayley's distance between two ranks x and y is the minimum number of transpositions required to transform the ranking x into y
#' @title Cayley's distance between two ranks
#' @author Julien Jacques
#' @param x,y two ranks of size m 
...
#' Hamming's distance between two ranks x and y is the number of difference between the two ranks.
